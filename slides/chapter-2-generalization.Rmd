...
.pull-left[
### Z-Distribution
- Categorical data - falls into specific groups; corresponding probabilities
- Test estimates of population proportions
- **Theory Validity Conditions** - 10 successes and 10 failures
- Can simulate because we have finite groups
].pull-right[
### T-Distribution
- Quantitative Data - numerical values, with mean/averages
- Want to run tests to estimate our population mean
- **Theory Validity Conditions** - $n \geq 20$ (sample size)
- Cannot simulate
