...
P-value from Theory based inference Applet: _______

---
## Significance test - Example 2.2 (Sleep)

**Interpretation** With our p-value of _____, we (reject/fail to reject), because the p-value is (less/greater) than 0.05.
...
- Assign appropriate symbols to the numbers: $$\;\;=48\;\;\;\;\; \;\;\;\;=35.29\;\;\;\;\; \;\;\;\;=17.19$$

- In the context of this stuudy, is the theory-based approach (one-sample t-test) valid to find a p-value to investigate whether the data provide evidence that the average SPF of sunscreens used by the students at this school exceeds 30? Explain
...
.red[We reject the null hypothesis, because p=0.191 is less than 0.05. We have evidence that the average SPF of sunscreen used by students at this college is higher than 30. ]
...
- How extreme is extreme enough?
  - Changes with the study: the consequences may be different for different types of errors    
...
---
## Errors
- Helper toy example: Do more than half the babies pick the helper toy? $$H_0: \pi = 0.5 \;\;\;\; H_A: \pi > 0.5$$
...
Common quiz/test question: Draw a conclusion for a study and determine which type of error you may have made
