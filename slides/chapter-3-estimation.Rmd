...
- February 18: [start](#3) - [end](#13)
- February 20: [start](#14) - [end](#30)
- February 25: [start](#31) - [end](#48)
- February 27: [start](#49) - [end](#56)
...
show_p_test <- function(idx, ptest, sample_p = 32/33, sample_n = 33) {
  ...
  ptestbin <- c("Reject", "Fail to Reject")[1 + as.numeric(ptestres > 0.05)]
  ...
  plot <- ggplot() + geom_line(aes(x = ps, y = dnorm(ps, mean = ptest[idx], sd = se))) +
    ...
    scale_colour_manual("Decision", values = c("Sample p" = "red", "Reject" = "orange", "Fail to Reject" = "blue"), na.val = "grey", drop = F) + 
