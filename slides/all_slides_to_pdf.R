...
html_to_pdf <- function(x) {
  ...
  system(paste0("pdfnup --nup 2x2 --frame true --noautoscale false --scale 0.92 --suffix 4 ", xpdf))
  system(paste0("pdfnup --nup 1x2 --frame true --noautoscale false --scale 0.92 --no-landscape --suffix 2 ", xpdf))
