...
![Social Interaction Experiment Setup. The helper puppet pushes the climber up the hill; the hinderer puppet pushes the climber down the hill.](social_interaction_experiment_setup.jpg)
...
.left-column[![Let's Make A Deal logo](https://upload.wikimedia.org/wikipedia/en/c/cf/LMADlogo2011.jpg)]
.right-column[
...
We can **simulate ** this game and keep track of how often we win the car. 
...
Work through Exploration P.3 in your groups. Submit the exploration on Canvas.
